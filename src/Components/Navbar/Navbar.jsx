  ...
  const links =
    <>
      <nav className='flex gap-x-10 justify-center items-center '>
        <NavLink className="hover:scale-105 transition text-xs md:text-base" to='/'>Home</NavLink>
        <NavLink className="hover:scale-105 transition text-xs md:text-base" to='/plants'>Plants</NavLink>
        <NavLink className="hover:scale-105 transition text-xs md:text-base" to='/profile'>Profile</NavLink>
      </nav>
    </>
  return (
    <div>
      <div className="navbar bg-gray-200 border-none shadow-sm p-5 max-w-7xl mx-auto">
        ...
        <div className="navbar-end flex gap-x-5">
          {
            user ? (<div className="dropdown dropdown-end">
              ...
              (<div className='flex gap-x-2 md:gap-x-5'>
                <NavLink to="/login"><button className="btn text-xs md:text-base w-18 md:w-24 bg-linear-to-r from-emerald-700 to-lime-600 text-white hover:scale-105 transition">Login</button></NavLink>
                <NavLink to="/register"><button className="btn text-xs md:text-base w-18 md:w-24 bg-linear-to-r from-emerald-700 to-lime-600 text-white hover:scale-105 transition">Register</button></NavLink>
              </div>)
          }
