...
//       <div className='flex flex-col md:flex-row items-start md:items-center px-5 md:px-0 gap-4'>
//         <h1 className='font-bold text-xl md:text-4xl text-center'>Plants Found: {filteredPlants.length}</h1>

//         <div className="flex flex-col md:flex-row gap-3 w-full md:w-auto">
//           <input
//             className="border border-emerald-700 rounded-md outline-none px-5 py-2 text-sm text-gray-500 w-full md:w-auto"
//             type="search"
...
//           <select
//             className="border border-emerald-700 text-emerald-700 font-medium bg-gray-200 rounded-md px-4 py-2 text-xs focus:outline-none w-full md:w-auto"
    ...
    <div className='max-w-7xl mx-auto pb-30 mt-15'>
      <div className='flex flex-col gap-4 px-5 md:px-0'>
        <div className='flex flex-col md:flex-row gap-5 md:gap-0 items-center justify-between'>
          <h1 className='font-bold text-3xl md:text-4xl w-full text-center md:text-start'>Plants Found: {filteredPlants.length}</h1>
          <div className='flex flex-col md:flex-row gap-3 md:justify-end w-full'>
            <select
              className="border border-emerald-700 text-emerald-700 font-medium bg-gray-200 rounded-md px-4 py-2 text-xs focus:outline-none w-full md:w-auto"
              onChange={(e) => setSortField(e.target.value)}
            >
